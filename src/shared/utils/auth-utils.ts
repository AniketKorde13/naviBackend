...
import { DEFAULT_OTP } from '../constants/common-constant';
...
function getPasswordDeriveBytes(salt: string, iterations: number, len: number) {
...
export const getTokenExpiry = () => {
    const expiry = new Date();
    expiry.setSeconds(expiry.getSeconds() + AUTH_TOKEN_EXPIRY);
    return {
        expiry,
    };
};
